...
export const mapDistricts: MapDistrict[] = [
  ...
  },
  {
    ...
    y: 72,
    tone: "amber",
    description: "Performance spaces, late sessions and venue-led collaborations.",
    pulse: "Live performance pulse",
    ...
    popover: { x: 78, y: 70, offsetX: "-100%", offsetY: "-100%" },
  },
];
...
export const mapSignals: MapSignal[] = [
  ...
  {
    id: "signal-testaccio-events",
    districtId: "testaccio",
    category: "events",
    x: 77,
    y: 76,
    title: "Courtyard Resonance",
